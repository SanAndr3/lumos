...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "lumos_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "LUMOS_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Lumos_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "lumos_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "lumos_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "lumos_lumos_7798-1", true, nil,
		},
		{
			"invalid epoch, undefined", "lumos_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "lumos_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
