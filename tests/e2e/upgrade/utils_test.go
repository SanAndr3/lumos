...
// TestLumosVersionsLess tests the LumosVersions type's Less method with
// different version strings
func TestLumosVersionsLess(t *testing.T) {
	var version LumosVersions
...
// TestLumosVersionsSwap tests the LumosVersions type's Swap method
func TestLumosVersionsSwap(t *testing.T) {
	var version LumosVersions
	value := "v9.1.0"
...
// TestLumosVersionsLen tests the LumosVersions type's Len method
func TestLumosVersionsLen(t *testing.T) {
	var version LumosVersions = []string{"v9.1.0", "v10.0.0"}
