...
import (
	...
	cryptocodec "github.com/lumoschain/lumos/v20/crypto/codec"
	enccodec "github.com/lumoschain/lumos/v20/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("lumos", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, lumostypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, lumostypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := MustParseDerivationPath(lumostypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Lumos implementation
	...
	// Equality of Eth and Lumos implementation
	...
	// Inequality of wrong derivation path of Eth and Lumos implementation
