...
import (
	...
	"github.com/lumoschain/lumos/v20/wallets/ledger"
	"github.com/lumoschain/lumos/v20/wallets/ledger/mocks"
...
func (suite *LedgerTestSuite) SetupTest() {
	...
	suite.ledger = ledger.LumosSECP256K1{Hub: hub, PrimaryWallet: mockWallet}
}
	...
	tmp := whitespaceRegex.ReplaceAllString(
		`{
			...
			"msgs":[{
				...
				"value":{
					"amount":[{"amount":"150","denom":"atom"}],
					"from_address":"lumos10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky",
					"to_address":"lumos1fx944mzagwdhx0wz7k9tfztc8g3lkfk6rrgv6l"
				}
			}],
			"sequence":"6"
		}`,
...
func (suite *LedgerTestSuite) getMockTxProtobuf() []byte {
	...
	msg := bankTypes.NewMsgSend(
		sdk.MustAccAddressFromBech32("lumos10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky"),
		sdk.MustAccAddressFromBech32("lumos1fx944mzagwdhx0wz7k9tfztc8g3lkfk6rrgv6l"),
		[]sdk.Coin{
			{
				Denom:  "atom",
