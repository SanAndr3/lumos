...
import (
	...
	"github.com/lumoschain/lumos/v20/encoding"
	"github.com/lumoschain/lumos/v20/x/evm/core/vm"

	// unnamed import of statik for swagger UI support
	_ "github.com/lumoschain/lumos/v20/client/docs/statik"
	"github.com/lumoschain/lumos/v20/utils"

	lumostypes "github.com/lumoschain/lumos/v20/types"
	"github.com/lumoschain/lumos/v20/x/epochs"
	epochskeeper "github.com/lumoschain/lumos/v20/x/epochs/keeper"
	epochstypes "github.com/lumoschain/lumos/v20/x/epochs/types"
	"github.com/lumoschain/lumos/v20/x/evm"
	evmkeeper "github.com/lumoschain/lumos/v20/x/evm/keeper"
	evmtypes "github.com/lumoschain/lumos/v20/x/evm/types"
	inflation "github.com/lumoschain/lumos/v20/x/inflation/v1"
	inflationkeeper "github.com/lumoschain/lumos/v20/x/inflation/v1/keeper"
	inflationtypes "github.com/lumoschain/lumos/v20/x/inflation/v1/types"

	"github.com/lumoschain/lumos/v20/app/ante"
	ethante "github.com/lumoschain/lumos/v20/app/ante/evm"
	"github.com/lumoschain/lumos/v20/app/post"
	v20 "github.com/lumoschain/lumos/v20/app/upgrades/v20"
	srvflags "github.com/lumoschain/lumos/v20/server/flags"
	"github.com/lumoschain/lumos/v20/x/erc20"
	erc20keeper "github.com/lumoschain/lumos/v20/x/erc20/keeper"
	erc20types "github.com/lumoschain/lumos/v20/x/erc20/types"
	"github.com/lumoschain/lumos/v20/x/feemarket"
	feemarketkeeper "github.com/lumoschain/lumos/v20/x/feemarket/keeper"
	feemarkettypes "github.com/lumoschain/lumos/v20/x/feemarket/types"
	"github.com/lumoschain/lumos/v20/x/staking"
	stakingkeeper "github.com/lumoschain/lumos/v20/x/staking/keeper"
	"github.com/lumoschain/lumos/v20/x/vesting"
	vestingkeeper "github.com/lumoschain/lumos/v20/x/vesting/keeper"
	vestingtypes "github.com/lumoschain/lumos/v20/x/vesting/types"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/lumoschain/lumos/v20/x/ibc/transfer"
	transferkeeper "github.com/lumoschain/lumos/v20/x/ibc/transfer/keeper"

	memiavlstore "github.com/crypto-org-chain/cronos/store"

	// Force-load the tracer engines to trigger registration due to Go-Ethereum v1.10.15 changes
	_ "github.com/lumoschain/lumos/v20/x/evm/core/tracers/js"
	_ "github.com/lumoschain/lumos/v20/x/evm/core/tracers/native"
)
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".lumosd")

	// manually update the power reduction by replacing micro (u) -> atto (a) lumos
	sdk.DefaultPowerReduction = lumostypes.PowerReduction
...
var (
	_ servertypes.Application = (*Lumos)(nil)
	_ ibctesting.TestingApp   = (*Lumos)(nil)
	_ runtime.AppI            = (*Lumos)(nil)
)

// Lumos implements an extended ABCI application. It is an application
...
func (*Lumos) SimulationManager() *module.SimulationManager {
	panic("unimplemented")
}

// NewLumos returns a reference to a new initialized Ethermint application.
func NewLumos(
	logger log.Logger,
	db dbm.DB,
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		...
		lumostypes.ProtoAccount, maccPerms,
...
func (app *Lumos) Name() string { return app.BaseApp.Name() }

func (app *Lumos) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := ante.HandlerOptions{
		Cdc:                    app.appCodec,
		AccountKeeper:          app.AccountKeeper,
		BankKeeper:             app.BankKeeper,
		ExtensionOptionChecker: lumostypes.HasDynamicFeeExtensionOption,
...
func (app *Lumos) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.mm.BeginBlock(ctx)
}

// EndBlocker updates every end block
func (app *Lumos) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.mm.EndBlock(ctx)
}

// The DeliverTx method is intentionally decomposed to calculate the transactions per second.
func (app *Lumos) FinalizeBlock(req *abci.RequestFinalizeBlock) (res *abci.ResponseFinalizeBlock, err error) {
	defer func() {
...
func (app *Lumos) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
	var genesisState lumostypes.GenesisState
...
func (app *Lumos) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.mm.PreBlock(ctx)
}

// LoadHeight loads state at a particular height
func (app *Lumos) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Lumos) ModuleAccountAddrs() map[string]bool {
...
func (app *Lumos) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Lumos's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Lumos) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Lumos's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Lumos) AppCodec() codec.Codec {
	return app.appCodec
}

// DefaultGenesis returns a default genesis from the registered AppModuleBasic's.
func (app *Lumos) DefaultGenesis() lumostypes.GenesisState {
	return app.BasicModuleManager.DefaultGenesis(app.appCodec)
}

// InterfaceRegistry returns Lumos's InterfaceRegistry
func (app *Lumos) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Lumos) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Lumos) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Lumos) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Lumos) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *Lumos) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Lumos) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *Lumos) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Lumos) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *Lumos) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Lumos) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *Lumos) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Lumos) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Lumos) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Lumos) GetTxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *Lumos) AutoCliOpts() autocli.AppOptions {
...
func (app *Lumos) setupUpgradeHandlers() {
	// v20 upgrade handler
