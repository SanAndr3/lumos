...
def test_block(lumos_cluster, geth):
    # Perform block queries (eth_getBlockByNumber & eth_getBlockByHash)
    # on lumos and geth nodes, and compare the responses
    # Case 1: block without transactions
    get_blocks(lumos_cluster, geth, False)
    # Case 2: block with transactions
    get_blocks(lumos_cluster, geth, True)


def get_blocks(lumos_rpc_ws, geth, with_transactions):
    w3: Web3 = lumos_rpc_ws.w3
    eth_rpc = w3.provider
    ...
    lumos_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [lumos_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(eth_rpc, geth_rpc, "eth_accounts", [])


def test_syncing(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(lumos_cluster, geth):
    # on lumos the proof query will fail for block numbers <= 2
...
def test_get_code(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(lumos_cluster, geth):
    w3: Web3 = lumos_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(lumos_cluster, geth):
...
def test_incomplete_send_transaction(lumos_cluster, geth):
