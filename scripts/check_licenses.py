...
There are the following license types that are used in the project:
    - ENCL: This license is used for all files containing Lumos IP.
...
EXEMPT_FILES: List[str] = [
    ...
    r"proto/lumos/revenue/v1/",  # All files in this folder
    r"proto/lumos/claims/v1/genesis\.proto$",
]
