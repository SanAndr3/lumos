...
import (
	...
	lumoscore "github.com/lumoschain/lumos/v20/x/evm/core/core"
...
// RANDAO implementation. See https://github.com/lumosnetwork/ethermint/pull/1520#pullrequestreview-1200504697
...
func (k *Keeper) NewEVM(
	...
	blockCtx := vm.BlockContext{
		CanTransfer: lumoscore.CanTransfer,
		Transfer:    lumoscore.Transfer,
		GetHash:     k.GetHashFn(ctx),
		Coinbase:    cfg.CoinBase,
		GasLimit:    lumostypes.BlockGasLimit(ctx),
	...
	txCtx := lumoscore.NewEVMTxContext(msg)
	if tracer == nil {
...
func (k Keeper) GetHashFn(ctx sdk.Context) vm.GetHashFunc {
	return func(height uint64) common.Hash {
		h, err := lumostypes.SafeInt64(height)
		if err != nil {
...
func (k *Keeper) ApplyMessageWithConfig(
	...
	// for more info https://github.com/lumosnetwork/ethermint/issues/1085
