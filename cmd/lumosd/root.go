...
import (
	...
	lumosclient "github.com/lumoschain/lumos/v20/client"
	"github.com/lumoschain/lumos/v20/client/block"
	"github.com/lumoschain/lumos/v20/client/debug"
	lumosserver "github.com/lumoschain/lumos/v20/server"
	servercfg "github.com/lumoschain/lumos/v20/server/config"
	srvflags "github.com/lumoschain/lumos/v20/server/flags"

	"github.com/lumoschain/lumos/v20/app"
	cmdcfg "github.com/lumoschain/lumos/v20/cmd/config"
	lumoskr "github.com/lumoschain/lumos/v20/crypto/keyring"
)

const EnvPrefix = "LUMOS"

type emptyAppOptions struct{}

func (ao emptyAppOptions) Get(_ string) interface{} { return nil }

// NewRootCmd creates a new root command for lumosd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, sdktestutil.TestEncodingConfig) {
	// we "pre"-instantiate the application for getting the injected/configured encoding configuration
	// and the CLI options for the modules
	// add keyring to autocli opts
	tempApp := app.NewLumos(
		log.NewNopLogger(),
		dbm.NewMemDB(),
		nil, true, nil,
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(lumoskr.Option()).
		WithViper(EnvPrefix).
	...
	lumosserver.AddCommands(
		rootCmd,
		lumosserver.NewDefaultStartOptions(a.newApp, app.DefaultNodeHome),
		a.appExport,
		addModuleInitFlags,
	)
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		lumosclient.KeyCommands(app.DefaultNodeHome),
	)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		lumosApp = app.NewLumos(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), appOpts)

		if err := lumosApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		lumosApp = app.NewLumos(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), appOpts)
	}

	return lumosApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}
