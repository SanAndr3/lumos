...
import (
	...
	"github.com/lumoschain/lumos/v20/app"
	...
	infltypes "github.com/lumoschain/lumos/v20/x/inflation/v1/types"

	evmtypes "github.com/lumoschain/lumos/v20/x/evm/types"
)

// genSetupFn is the type for the module genesis setup functions
type genSetupFn func(lumosApp *app.Lumos, genesisState lumostypes.GenesisState, customGenesis interface{}) (lumostypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	...
	consensustypes.ModuleName: func(_ *app.Lumos, genesisState lumostypes.GenesisState, _ interface{}) (lumostypes.GenesisState, error) {
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(lumosApp *app.Lumos, genesisState lumostypes.GenesisState, customGenesis interface{}) (lumostypes.GenesisState, error) {
		moduleGenesis, ok := customGenesis.(T)
		if !ok {
			return nil, fmt.Errorf("invalid type %T for %s module genesis state", customGenesis, moduleName)
		}

		genesisState[moduleName] = lumosApp.AppCodec().MustMarshalJSON(moduleGenesis)
		return genesisState, nil
	}
}
...
// createLumosApp creates an lumos app
func createLumosApp(chainID string, customBaseAppOptions ...func(*baseapp.BaseApp)) *app.Lumos {
	// Create lumos app
	db := dbm.NewMemDB()
...
func setDefaultStakingGenesisState(lumosApp *app.Lumos, genesisState lumostypes.GenesisState, overwriteParams StakingCustomGenesisState) lumostypes.GenesisState {
	// Set staking params
	...
	genesisState[stakingtypes.ModuleName] = lumosApp.AppCodec().MustMarshalJSON(stakingGenesis)
	return genesisState
}
...
func setDefaultBankGenesisState(lumosApp *app.Lumos, genesisState lumostypes.GenesisState, overwriteParams BankCustomGenesisState) lumostypes.GenesisState {
	...
	genesisState[banktypes.ModuleName] = lumosApp.AppCodec().MustMarshalJSON(bankGenesis)
	return genesisState
}
...
func setDefaultSlashingGenesisState(lumosApp *app.Lumos, genesisState lumostypes.GenesisState, overwriteParams SlashingCustomGenesisState) lumostypes.GenesisState {
	...
	genesisState[slashingtypes.ModuleName] = lumosApp.AppCodec().MustMarshalJSON(slashingGen)
	return genesisState
}

// setBankGenesisState updates the bank genesis state with custom genesis state
func setBankGenesisState(lumosApp *app.Lumos, genesisState lumostypes.GenesisState, customGenesis interface{}) (lumostypes.GenesisState, error) {
	...
	lumosApp.AppCodec().MustUnmarshalJSON(genesisState[banktypes.ModuleName], bankGen)
	...
	genesisState[banktypes.ModuleName] = lumosApp.AppCodec().MustMarshalJSON(bankGen)
	return genesisState, nil
}
...
func setDefaultAuthGenesisState(lumosApp *app.Lumos, genesisState lumostypes.GenesisState, genAccs []authtypes.GenesisAccount) lumostypes.GenesisState {
	defaultAuthGen := authtypes.NewGenesisState(authtypes.DefaultParams(), genAccs)
	genesisState[authtypes.ModuleName] = lumosApp.AppCodec().MustMarshalJSON(defaultAuthGen)
	return genesisState
}

// setAuthGenesisState updates the bank genesis state with custom genesis state
func setAuthGenesisState(lumosApp *app.Lumos, genesisState lumostypes.GenesisState, customGenesis interface{}) (lumostypes.GenesisState, error) {
	...
	lumosApp.AppCodec().MustUnmarshalJSON(genesisState[authtypes.ModuleName], authGen)
	...
	genesisState[authtypes.ModuleName] = lumosApp.AppCodec().MustMarshalJSON(authGen)
	return genesisState, nil
}
...
func setDefaultGovGenesisState(lumosApp *app.Lumos, genesisState lumostypes.GenesisState, overwriteParams GovCustomGenesisState) lumostypes.GenesisState {
	...
	genesisState[govtypes.ModuleName] = lumosApp.AppCodec().MustMarshalJSON(govGen)
	return genesisState
}

func setDefaultErc20GenesisState(lumosApp *app.Lumos, genesisState lumostypes.GenesisState) lumostypes.GenesisState {
	erc20Gen := erc20types.DefaultGenesisState()
	genesisState[erc20types.ModuleName] = lumosApp.AppCodec().MustMarshalJSON(erc20Gen)
	return genesisState
}

// defaultAuthGenesisState sets the default genesis state
// for the testing setup
func newDefaultGenesisState(lumosApp *app.Lumos, params defaultGenesisParams) lumostypes.GenesisState {
	genesisState := lumosApp.DefaultGenesis()

	genesisState = setDefaultAuthGenesisState(lumosApp, genesisState, params.genAccounts)
	genesisState = setDefaultStakingGenesisState(lumosApp, genesisState, params.staking)
	genesisState = setDefaultBankGenesisState(lumosApp, genesisState, params.bank)
	genesisState = setDefaultGovGenesisState(lumosApp, genesisState, params.gov)
	genesisState = setDefaultSlashingGenesisState(lumosApp, genesisState, params.slashing)
	genesisState = setDefaultErc20GenesisState(lumosApp, genesisState)
...
func customizeGenesis(lumosApp *app.Lumos, customGen CustomGenesisState, genesisState lumostypes.GenesisState) (lumostypes.GenesisState, error) {
	var err error
	for mod, modGenState := range customGen {
		if fn, found := genesisSetupFunctions[mod]; found {
			genesisState, err = fn(lumosApp, genesisState, modGenState)
			if err != nil {
