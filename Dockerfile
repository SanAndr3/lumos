...
WORKDIR /go/src/github.com/lumoschain/lumos
...
COPY --from=build-env /go/src/github.com/lumoschain/lumos/build/lumosd /usr/bin/lumosd
...
RUN apk add --no-cache \
    ...
    lz4 \
    rclone \
    && addgroup -g 1000 lumos \
    && adduser -S -h /home/lumos -D lumos -u 1000 -G lumos
