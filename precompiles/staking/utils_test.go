...
import (
	...
	cmnfactory "github.com/lumoschain/lumos/v20/testutil/integration/common/factory"
...
func (s *PrecompileTestSuite) setupVestingAccount(funder, vestAcc testkeyring.Key) *vestingtypes.ClawbackVestingAccount {
	...
	fundMsg := vestingtypes.NewMsgFundVestingAccount(
		...
		vestAcc.AccAddr,
		vestingStart,
		lumosutil.TestVestingSchedule.LockupPeriods,
		lumosutil.TestVestingSchedule.VestingPeriods,
	)
