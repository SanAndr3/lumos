...
import (
	...
	teststypes "github.com/lumoschain/lumos/v20/types/tests"
)

func init() {
	cfg := sdk.GetConfig()
	cfg.SetBech32PrefixForAccount("lumos", "lumospub")
}
...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "cosmos1",
				Receiver: "lumos1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Amount:   "123456",
			},
			expSender:    "",
			expRecipient: "",
		...
		{
			name: "valid - cosmos sender, lumos recipient",
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
				Receiver: "lumos1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Amount:   "123456",
			},
			expSender:    "lumos1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			expRecipient: "lumos1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			expError:     false,
		},
		{
			name: "valid - lumos sender, cosmos recipient",
			data: transfertypes.FungibleTokenPacketData{
				Sender:   "lumos1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
				Receiver: "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
				Amount:   "123456",
			},
			expSender:    "lumos1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
			expRecipient: "lumos1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			expError:     false,
		},
		{
			name: "valid - osmosis sender, lumos recipient",
			data: transfertypes.FungibleTokenPacketData{
...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/alumos",
			"10",
			sdk.Coin{Denom: "alumos", Amount: math.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped alumos coin",
			"alumos",
			"10",
			sdk.Coin{Denom: "alumos", Amount: math.NewInt(10)},
		},
		{
			"get ibc wrapped alumos coin",
			"transfer/channel-0/alumos",
			"10",
			sdk.Coin{Denom: teststypes.AlumosIbcdenom, Amount: math.NewInt(10)},
		},
		{
...
func TestDeriveDecimalsFromDenom(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expDec:    0,
			expFail:   true,
			expErrMsg: "Should be either micro ('u[...]') or atto ('a[...]'); got: \"nlumos\"",
		},
		{
