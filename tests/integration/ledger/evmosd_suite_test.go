...
import (
	...
	"github.com/lumoschain/lumos/v20/tests/integration/ledger/mocks"
	...
	clientkeys "github.com/lumoschain/lumos/v20/client/keys"
	lumoskeyring "github.com/lumoschain/lumos/v20/crypto/keyring"
...
func (suite *LedgerTestSuite) SetupLumosApp() {
...
func (suite *LedgerTestSuite) lumosAddKeyCmd() *cobra.Command {
...
func (suite *LedgerTestSuite) MockKeyringOption() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = lumoskeyring.SupportedAlgorithms
		options.SupportedAlgosLedger = lumoskeyring.SupportedAlgorithmsLedger
		options.LedgerDerivation = func() (cosmosledger.SECP256K1, error) { return suite.ledger, nil }
		options.LedgerCreateKey = lumoskeyring.CreatePubkey
		options.LedgerAppName = lumoskeyring.AppName
		options.LedgerSigSkipDERConv = lumoskeyring.SkipDERConversion
	}
}
