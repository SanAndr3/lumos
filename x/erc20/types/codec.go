...
const (
	// Amino names
	convertERC20Name = "lumos/MsgConvertERC20"
	convertCoinName  = "lumos/MsgConvertCoin" // keep it for backwards compatibility when querying txs
	updateParams     = "lumos/erc20/MsgUpdateParams"
	registerERC20    = "lumos/erc20/MsgRegisterERC20"
	toggleConversion = "lumos/erc20/MsgToggleConversion"
)
