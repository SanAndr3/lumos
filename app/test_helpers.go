...
// Setup initializes a new Lumos. A Nop logger is set in Lumos.
func Setup(
	isCheckTx bool,
...
func GenesisStateWithValSet(app *Lumos, genesisState lumostypes.GenesisState,
	valSet *cmttypes.ValidatorSet, genAccs []authtypes.GenesisAccount,
	balances ...banktypes.Balance,
) lumostypes.GenesisState {
