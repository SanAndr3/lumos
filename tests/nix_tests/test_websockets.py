def test_single_request_netversion(lumos_cluster):
    lumos_cluster.use_websocket()
    eth_ws = lumos_cluster.w3.provider
...
def test_batch_request_netversion(lumos):
    return


def test_ws_subscribe_log(lumos):
    return


def test_ws_subscribe_newheads(lumos):
    return
