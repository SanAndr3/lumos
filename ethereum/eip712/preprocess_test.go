...
import (
	...
	"github.com/lumoschain/lumos/v20/cmd/config"
...
var feePayerAddress = "lumos17xpfvakm2amg962yls6f84z3kell8c5ljcjw34"
...
func createPopulatedTestCase(t *testing.T) TestCaseStruct {
	...
	msgSend := banktypes.MsgSend{
		...
		ToAddress:   "lumos12luku6uxehhak02py4rcz65zu0swh7wjun6msa",
		Amount: sdk.NewCoins(
			sdk.NewCoin(
				utils.BaseDenom,
