...
const (
	// MainnetChainID defines the Lumos EIP155 chain ID for mainnet
	MainnetChainID = "lumos_7799"
	// TestnetChainID defines the Lumos EIP155 chain ID for testnet
	TestnetChainID = "lumos_7798"
	// TestingChainID defines the Lumos EIP155 chain ID for integration test
	TestingChainID = "test_1317"
	// BaseDenom defines the Lumos mainnet denomination
	BaseDenom = "alumos"
)
...
// IsMainnet returns true if the chain-id has the Lumos mainnet EIP155 chain prefix.
func IsMainnet(chainID string) bool {
	return strings.HasPrefix(chainID, MainnetChainID)
}

// IsTestnet returns true if the chain-id has the Lumos testnet EIP155 chain prefix.
...
// GetLumosAddressFromBech32 returns the sdk.Account address of given address,
// while also changing bech32 human readable prefix (HRP) to the value set on
// the global sdk.Config (eg: `lumos`).
// The function fails if the provided bech32 address is invalid.
func GetLumosAddressFromBech32(address string) (sdk.AccAddress, error) {
