...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*lumostypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*lumostypes.TxResult, error)
...
type Backend struct {
	...
	indexer             lumostypes.EVMTxIndexer
}
...
func NewBackend(
	...
	chainID, err := lumostypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
