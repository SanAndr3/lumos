...
import (
	...
	"github.com/lumoschain/lumos/v20/ethereum/eip712"
	"github.com/lumoschain/lumos/v20/wallets/accounts"
	"github.com/lumoschain/lumos/v20/wallets/usbwallet"
)
...
func LumosLedgerDerivation() Secp256k1DerivationFn {
	lumosSECP256K1 := new(LumosSECP256K1)

	return func() (sdkledger.SECP256K1, error) {
		return lumosSECP256K1.connectToLedgerApp()
	}
}

var _ sdkledger.SECP256K1 = &LumosSECP256K1{}

// LumosSECP256K1 defines a wrapper of the Ethereum App to
// for compatibility with Cosmos SDK chains.
type LumosSECP256K1 struct {
	*usbwallet.Hub
...
func (e LumosSECP256K1) Close() error {
...
func (e LumosSECP256K1) GetPublicKeySECP256K1(hdPath []uint32) ([]byte, error) {
	if e.PrimaryWallet == nil {
...
// GetAddressPubKeySECP256K1 takes in the HD path as well as a "Human Readable Prefix" (HRP, e.g. "lumos")
// to return the public key bytes in secp256k1 format as well as the account address.
func (e LumosSECP256K1) GetAddressPubKeySECP256K1(hdPath []uint32, hrp string) ([]byte, string, error) {
	if e.PrimaryWallet == nil {
...
func (e LumosSECP256K1) SignSECP256K1(hdPath []uint32, signDocBytes []byte, _ byte) ([]byte, error) {
...
func (e LumosSECP256K1) displayEIP712Hash(typedData apitypes.TypedData) error {
...
func (e *LumosSECP256K1) connectToLedgerApp() (sdkledger.SECP256K1, error) {
