...
import (
	...
	"github.com/lumoschain/lumos/v20/testutil/integration/common/factory"
	lumosfactory "github.com/lumoschain/lumos/v20/testutil/integration/lumos/factory"
	...
	"github.com/lumoschain/lumos/v20/x/vesting/types"
...
type KeeperTestSuite struct {
	...
	factory lumosfactory.TxFactory
}
...
//
// Example:
// 21/10 Employee joins Lumos and vesting starts
...
var _ = Describe("Clawback Vesting Account - Smart contract", func() {
	...
	BeforeEach(func() {
		...
		contractAddr, err = s.factory.DeployContract(
			...
			evmtypes.EvmTxArgs{},
			lumosfactory.ContractDeploymentData{
				Contract:        contract,
