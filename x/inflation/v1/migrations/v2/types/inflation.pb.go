...
// The initial V2InflationDistribution can be calculated from the Lumos Token
// Model like this:
...
func init() {
	proto.RegisterType((*V2InflationDistribution)(nil), "lumos.inflation.v1.V2InflationDistribution")
	proto.RegisterType((*V2ExponentialCalculation)(nil), "lumos.inflation.v1.V2ExponentialCalculation")
}

func init() {
	proto.RegisterFile("lumos/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
